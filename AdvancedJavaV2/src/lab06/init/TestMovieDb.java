...
public class TestMovieDb {
	...
	public static void runTest(MovieDb movies) {
		...
		Movie foundMovie = movies.findByName("The Simpsons");
		Integer releaseYear = foundMovie != null ? foundMovie.getReleaseYear() : 0;
		System.out.println("Year of release for The Simpsons: " + releaseYear);
